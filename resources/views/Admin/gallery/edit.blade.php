...
<div class="nk-block nk-block-lg">
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="title nk-block-title">Gallery Edit</h4>
        </div>
    </div>
    <div class="card">
        <div class="card-inner">
             <form method="POST" id="biodata_form" class="form-horizontal" action="{{route('gallery.update',$gallery->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                 ...
                 <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="category" class="form-control" value="{{$gallery->category}}" placeholder="Category Name">
                    ...
                    <div class="col-md-3">
                         @if($gallery->image)
                            <img src="{{ asset($gallery->image) }}" width="100px;" alt="">
                          @endif
                    </div>
                    <div class="col-12">
                        <div class="form-group">
