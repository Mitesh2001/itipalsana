...
<div class="nk-block nk-block-lg">
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="title nk-block-title">Trades Add</h4>
        </div>
    </div>
    <div class="card">
        <div class="card-inner">
             <form method="POST" id="biodata_form" class="form-horizontal" action="{{ route('trades.store') }}" enctype="multipart/form-data">
                    @csrf
                 <div class="row g-4">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="affilated" class="form-control" value="{{old('affilated')}}" placeholder="affilated">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="seats" class="form-control" value="{{old('seats')}}" placeholder="Seats">
                                @if ($errors->has('seats')) 
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="batches" class="form-control" maxlength="10" value="{{old('batches')}}" placeholder="batches">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="eligibility" class="form-control" maxlength="10" value="{{old('eligibility')}}" placeholder="eligibility">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="duration" class="form-control" maxlength="10" value="{{old('duration')}}" placeholder="duration">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="benefits" class="form-control" maxlength="10" value="{{old('benefits')}}" placeholder="benefits">
