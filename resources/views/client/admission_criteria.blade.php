...
<div class="clearfix"></div>	
		...
		<div class="row abtbgrow">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="abttitle">
                        {{ isset($admission_criteria->page_title) ? $admission_criteria->page_title:'' }} 
                    </h2>
					</div>
				</div>
			</div>
	...
	<div class="container sppagespace">
		<div style="padding-bottom: 20px; font-size: 20px; border-bottom: 1px solid #dcdbda;">  {{ isset($admission_criteria->category) ? $admission_criteria->category:'' }} </div>
		
		{!!$admission_criteria->content!!}
